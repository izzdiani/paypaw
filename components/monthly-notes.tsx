    ...
    <section className="rounded-2xl bg-white/85 p-4 shadow-soft">
      <label className="grid gap-2 text-sm font-bold text-paw-plum">
        ...
        <textarea
          ...
          className="min-h-28 resize-none rounded-xl border border-paw-lavender bg-paw-cream px-3 py-3 text-sm font-semibold text-paw-plum outline-none focus:border-paw-purple"
